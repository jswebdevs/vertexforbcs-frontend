...
import "./StudentCalendar.css"; // Use your existing CSS styles

const StudentCalendar = ({ quizzes = [] }) => {
  ...
  return (
    <div className="calendar-container">
      ...
      {tooltip.visible && (
        <div
          className="tooltip"
          style={{ top: tooltip.y - 10, left: tooltip.x - 10 }} // Offset for better visibility
        >
          {tooltip.content}
        </div>
      )}
